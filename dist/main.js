...
/*!********************!*\
  !*** ./src/dom.js ***!
  \********************/
/*! exports provided: createEvents, createEventsForButtons */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createEvents", function() { return createEvents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createEventsForButtons", function() { return createEventsForButtons; });
...
function createTaskElement(task) {
  ...
  createH4.textContent = `Created: ${Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["format"])(
  ...
  dueH4.textContent = `Due: ${Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["format"])(task.getDueDate(), 'd MMMM yyyy')}`;
...
const createEvents = (() => {
  ...
  const byDate = (element, date) => {
    element.addEventListener('click', () => {
      ...
      _tasks_js__WEBPACK_IMPORTED_MODULE_1__["CurrentTasks"].setCurrentTasks(_tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].getTasksToDate(date));
      clearContent();
  ...
  const byCategory = (element, category) => {
    element.addEventListener('click', () => {
      _updateCurrentProjectTitle(element.textContent);
      _tasks_js__WEBPACK_IMPORTED_MODULE_1__["CurrentTasks"].setCurrentTasks(_tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].getTasksByCategory(category));
      clearContent();
      updateContent(_tasks_js__WEBPACK_IMPORTED_MODULE_1__["CurrentTasks"].getCurrentTasks());
      currentMark.moveCurrent(element);
    });
  ...
  const allTasks = (element) => {
    element.addEventListener('click', () => {
      _updateCurrentProjectTitle(element.textContent);
      _tasks_js__WEBPACK_IMPORTED_MODULE_1__["CurrentTasks"].setCurrentTasks(_tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].getAllTasks());
      clearContent();
      updateContent(_tasks_js__WEBPACK_IMPORTED_MODULE_1__["CurrentTasks"].getCurrentTasks());
      currentMark.moveCurrent(element);
    });
...
const createEventsForButtons = (() => {
  ...
  const removeTask = (e) => {
    ...
    _tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].removeTask(id);
    clearContent();
    updateContent(_tasks_js__WEBPACK_IMPORTED_MODULE_1__["CurrentTasks"].getCurrentTasks());
  };
  ...
  const expandTask = (e) => {
    if (e.target === e.currentTarget) {
			...
			_tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].getTaskById(id).toggleExpanded();
    }
  };
  ...
  const editTask = (e) => {
    ...
    taskFormElement.querySelector('.form-date').value = Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["format"])(
      task.getDueDate(),
      'yyyy-MM-dd'
    );
  ...
  const markDone = (e) => {
    const id = e.target.parentNode.getAttribute('data');
    const task = _tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].getTaskById(id);
    _tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].getTaskById(id).toggleFinished();
  ...
  const markImportant = (e) => {
    const id = e.target.parentNode.getAttribute('data');
    const task = _tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].getTaskById(id);
    _tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].getTaskById(id).toggleImportant();
  ...
  const formAddTask = (e) => {
    ...
    _tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].addNewTask(
      inputTitle.value,
      inputDate.value,
  ...
  const formEditTask = (id, e) => {
    ...
    _tasks_js__WEBPACK_IMPORTED_MODULE_1__["TaskStorage"].editTask(
      id,
      inputTitle.value,
      inputDate.value,
      inputDescription.value,
...
_dom_js__WEBPACK_IMPORTED_MODULE_1__["createEvents"].byDate(document.querySelector('.today'), Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["endOfToday"])());
_dom_js__WEBPACK_IMPORTED_MODULE_1__["createEvents"].byDate(document.querySelector('.week'), Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["endOfWeek"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["endOfToday"])()));
_dom_js__WEBPACK_IMPORTED_MODULE_1__["createEvents"].byDate(document.querySelector('.month'), Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["endOfMonth"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["endOfToday"])()));
_dom_js__WEBPACK_IMPORTED_MODULE_1__["createEvents"].allTasks(document.querySelector('.all'));
...
/*!**********************!*\
  !*** ./src/tasks.js ***!
  \**********************/
/*! exports provided: TaskStorage, CurrentTasks */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TaskStorage", function() { return TaskStorage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CurrentTasks", function() { return CurrentTasks; });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/index.js");
...
const TaskStorage = (() => {
  ...
  const getTasksToDate = (date) => {
    ...
    for (let task of _taskStore) {
      if (Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["isBefore"])(task.getDueDate(), date)) {
